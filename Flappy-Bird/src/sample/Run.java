...
public class Run {
    ...
    public Run(ImageView b, boolean g, ImageView rT, ImageView rD, ImageView rT2, ImageView rD2, Pane p) throws InterruptedException {
        game = g;
        this.b = b;
        rTop = rT;
        rDown = rD;
            ...
            protected Void call() throws Exception {
                while (game && Platform.isImplicitExit()) {
                    ...
                    if (b.getLayoutY() <= 0 || b.getLayoutY() >= 532) {
                        ...
                        try {
                            if (GlobalVar.score > ReadWriteXML.readHighscore()) {
                                ReadWriteXML.writeHighscore(GlobalVar.score);
                                ReadWriteXML.write(ReadWriteXML.readName(), ReadWriteXML.readHighscore());
